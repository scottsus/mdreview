          ...
          <div className="relative overflow-hidden">
            <div
              ...
              className={cn(
                ...
                "[&_code:not(pre_code)]:bg-zinc-200 [&_code:not(pre_code)]:dark:bg-zinc-700 [&_code:not(pre_code)]:text-blue-700 [&_code:not(pre_code)]:dark:text-blue-300 [&_code:not(pre_code)]:px-1.5 [&_code:not(pre_code)]:py-0.5 [&_code:not(pre_code)]:!rounded-[3px] [&_code:not(pre_code)]:text-sm [&_code:not(pre_code)]:font-normal [&_code:not(pre_code)]:before:content-none [&_code:not(pre_code)]:after:content-none",
